...
This analysis, as a project, began from a question, why the concept of Swarm was so captivating, - it's nature as an unclassified entity, in a larger scope from a sence that it is a storytelling element, a trope, or a narreme, was so captivating for more than a decade after the game had initially launched. Why amongs all of content and context present in the game, metaphysics of the last remaining and most mysterious entity, represented as Shadow Lairs, was the element which propelled this analysis. -->
