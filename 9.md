...
Before proceeding, we have to introduce a concept, which, paired with the symbolic themes, we believe, will affirm the further discussed topics, relating to alchemy.

understanding of the  one important aspect of the design of Shadow Lairs should be looked at. We suggest, that the general concept of a descend into the Shadow Lairs, then the Sanctuary, and aquisition of a rare material, unique to the lair is an alchemical metaphor for the process of creation of the Great Work, and of a particular kind. By that we mean, as the phenomenon of alchemy as pseudo-chemistry is rooted from a projection of inner consciousness onto a physical world in attempt to explain it, its elements also become symbolic. So is also true for the its results - Great Work.

As Great Work Here we propose a similar correspondn

It is concealed in the description of the alchemical process from the english translation of Carl Jung's "Psychology and Alchemy":
...
- The architect, a supposed king Tinkinzar, makes a Pact with an entity known as Sleeper.
...
- The madness in question, then, if we are looking for its reason as external, should thematically be related to such entities as Nefarious Imp or Apocrea.
    ...
    Is this time, the civilization in question is to be faced with the Underworld, with the accumulation of past histories, as well as stakes, it would be fitting for the nature of this danger be the same, yet tested to the extremes as far as the established metaphysics of the fictional Unverse would allow, without breaking the suspension of disbelief by an unpredictable force, which was written into the canon in the last moment.

    Essentially, due to this logic we have this proposal reinstated here. The reason for Tinkinzar's madness as well as Swarm's creation had to be related with the nature of curse and Underworld.

As for the precise nature of the affliction, we can suggest, based on the eldritch component to the narrative, it can go from a through out explanation, revealing nature of immortality through curse, to a simple, generally accepted form of a hand wave. Either way, the nature of this madness, we believe, has to be rooted in a narrative of a cosmic horror story, by being a case of [going mad from the revelation](https://tvtropes.org/pmwiki/pmwiki.php/Main/GoMadFromTheRevelation). The other component - the execution of this concept, relies on the ability to flash out the revelation itself, as well as the character afflicted by it.
